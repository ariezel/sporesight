...
"border-radius: 15px;")
        ...
        self.verticalLayout_5 = QVBoxLayout(self.feed_body_frame)
        ...
        self.verticalLayout_5.addWidget(self.feed_camera)

        self.feed_body_desc = QFrame(self.feed_body_frame)
        self.feed_body_desc.setObjectName(u"feed_body_desc")
        self.feed_body_desc.setMaximumSize(QSize(16777215, 60))
        self.feed_body_desc.setFrameShape(QFrame.StyledPanel)
        self.feed_body_desc.setFrameShadow(QFrame.Raised)
        self.verticalLayout_6 = QVBoxLayout(self.feed_body_desc)
        self.verticalLayout_6.setSpacing(0)
        self.verticalLayout_6.setObjectName(u"verticalLayout_6")
        self.verticalLayout_6.setContentsMargins(0, 0, 0, 0)
        self.feed_desc = QLabel(self.feed_body_desc)
        self.feed_desc.setObjectName(u"feed_desc")
        self.feed_desc.setMaximumSize(QSize(16777215, 16777215))

        self.verticalLayout_6.addWidget(self.feed_desc)


        self.verticalLayout_5.addWidget(self.feed_body_desc)
